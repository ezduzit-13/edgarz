...
const MyInterest = () => {
  return (
    ...
    <div style={textStyle}>
      ...
      <h3>While in the military, I worked as an avionics technician. Meaning I got to work with all of the electronics on the aircraft. Specifically, I worked on the MC-130J and the MC-130H. I also got to work on many other types of tech such as 3D Printers and Laser Engravers. I noticed that what made all of these devices really cool was the fact that they had software that made them do really cool things. That was when I decided to get out of the military to give all of my attention towards getting my Computer Science Degree </h3>
      </div>
    </div>
    </div>
    <br /><br />
